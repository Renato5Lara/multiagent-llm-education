...
| [Nota — Interacción de Consentimiento](NOTA-INTERACCION-CONSENTIMIENTO.md) | Preguntas de diseño de interacción, precede la implementación de Adenda B | Cerrada — 2 decisiones registradas |
