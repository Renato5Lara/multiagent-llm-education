"""Remediar (R6): reaccionar cuando no aprende (RFC-0002 §3).
...
from runtime.domain.remediar.productor import producir
from runtime.domain.remediar.productor_llm import producir as producir_llm
